...
class SNDCGAN_Discrminator(object):
  ...
  def __call__(self, x, update_collection=tf.GraphKeys.UPDATE_OPS, **kwargs):
    with tf.variable_scope(self.scope):
      c0_0 = self.hidden_activation(conv2d(   x,  64, 3, 3, 1, 1, mhe=True, net_type='d',
        spectral_normed=False, update_collection=update_collection, stddev=0.02, name='c0_0'))
      c0_1 = self.hidden_activation(conv2d(c0_0, 128, 4, 4, 2, 2, mhe=True, net_type='d',
        spectral_normed=False, update_collection=update_collection, stddev=0.02, name='c0_1'))
      c1_0 = self.hidden_activation(conv2d(c0_1, 128, 3, 3, 1, 1, mhe=True, net_type='d',
        spectral_normed=False, update_collection=update_collection, stddev=0.02, name='c1_0'))
      c1_1 = self.hidden_activation(conv2d(c1_0, 256, 4, 4, 2, 2, mhe=True, net_type='d',
        spectral_normed=False, update_collection=update_collection, stddev=0.02, name='c1_1'))
      c2_0 = self.hidden_activation(conv2d(c1_1, 256, 3, 3, 1, 1, mhe=True, net_type='d',
        spectral_normed=False, update_collection=update_collection, stddev=0.02, name='c2_0'))
      c2_1 = self.hidden_activation(conv2d(c2_0, 512, 4, 4, 2, 2, mhe=True, net_type='d',
        spectral_normed=False, update_collection=update_collection, stddev=0.02, name='c2_1'))
      c3_0 = self.hidden_activation(conv2d(c2_1, 512, 3, 3, 1, 1, mhe=True, net_type='d',
        spectral_normed=False, update_collection=update_collection, stddev=0.02, name='c3_0'))
      c3_0 = tf.reshape(c3_0, [self.batch_size, -1])
      l4 = linear(c3_0, self.output_dim, mhe=True, net_type='d',
        spectral_normed=False, update_collection=update_collection, stddev=0.02, name='l4')
